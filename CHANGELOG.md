...
- Skill `obsidian-second-brain` (MIT, v0.15.0) adicionada em `.claude/skills/`, com guia de instalação em `OBSIDIAN-SEGUNDO-CEREBRO.md` e manual do cofre pré-preenchido em `MODELO-COFRE-CLAUDE.md`
