...
- Servidor MCP `postgres` (Postgres MCP Pro, da Crystal DBA) declarado no `.mcp.json`, em modo somente leitura, com conexão via `DATABASE_URI` + skill `.claude/skills/postgres-mcp/`
